...
//    property bool handleHovered : false
   ...
   __horizontalScrollBar.visible : behaviours.containsMouse ? true : false
...
//               }
   ...
   MouseArea{
       ...
       onEntered: {
           ...
           scrollview.__horizontalScrollBar.visible = true;
//           console.log("mouse enter position: " + mouseX + "-" + mouseY)
       }
       onExited: {
//           scrollview.__verticalScrollBar.visible = false;
//           scrollview.__horizontalScrollBar.visible = false;
//           console.log("mouse exit position: " + mouseX + "-" + mouseY)
